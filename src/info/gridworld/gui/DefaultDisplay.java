 ...
 * @author Robert Glen Martin - Sudoku changes
 */
...
/**
 * The DefaultDisplay draws the object's text property with a background
...
public class DefaultDisplay implements Display
{
     ...
     */
    public void draw(Object obj, Component comp,
    	             Graphics2D g2, Rectangle rect)
    {
        ...
        Color textColor = 											// RGM
        	(Color) AbstractDisplay.getProperty(obj, "textColor");	// RGM
		if (textColor == null)										// RGM
        	textColor = Color.BLACK;								// RGM
     ...
     */
    protected void paintCenteredText(Graphics2D g2, String s,
   		Rectangle rect, double fontHeight, Color color)
    {
