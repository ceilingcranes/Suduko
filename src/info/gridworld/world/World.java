 ...
 * <br />
 * This class has been modified for the Sudoku game.  It is now abstract
 * and has three new abstract methods that are implemented in
 * <code>SudokuWorld</code>.  The new methods are
 * <code>newPuzzle</code>, <code>solve</code>, and <code>clear</code>.
 */
public abstract class World<T>	// RGM
{
    private Grid<T> gr;
	 ...
	 */
	public abstract void newPuzzle(int difficulty, int puzzleLoc);
